...
export const controlsData = [
  ...
  { icon: 'profile', type: TYPES.NAME, name: 'Name', text:'', placeholder: '', isSaveInVariable: false },
  ...
  { icon: 'button', type: TYPES.BUTTON, name: 'Button', options: [] },
  ...
  { icon: 'list', type: TYPES.LIST, name: 'List', text: '', options: [], isEnableSearch: false, isEnableMultiSelect: false, isSaveInVariable: false}
];
